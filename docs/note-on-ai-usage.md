...
The design and architecture of jero was entirely driven by the author and was motivated by experience with building on top of Django/DRF, Flask, Express, FastAPI, Elysia, etc. and implementing/re-implementing the same patterns in those frameworks that jero aims to formalise.
